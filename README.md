...
## 🖋️ Wireframe del Proyecto (link wireframe)

Hemos creado versiones adaptadas para dispositivos móviles y de escritorio utilizando Figma. Puedes ver las imágenes optimizadas en la carpeta `wireframes` o acceder a ellas [aquí](https://github.com/chavow5/Grupo_6_DronsAR/tree/main/wireframes).
